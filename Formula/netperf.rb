...
__END__
diff src/net_uuid.c src/net_uuid.c
...
+  netperf_uuid_t u;
 ...
 #if 0
   uuid_create(&u);
diff src/netlib.c src/netlib.c
...
diff src/netperf.c src/netperf.c
...
+#define WIN32_LEAN_AND_MEAN 1
 ...
 #include "missing\stdint.h"
 #endif /* WIN32 */
diff src/netserver.c src/netserver.c
...
+#define WIN32_LEAN_AND_MEAN 1
 ...
 #include "missing\stdint.h"
diff src/nettest_bsd.c src/nettest_bsd.c
